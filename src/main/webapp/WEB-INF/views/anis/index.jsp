...
<head>
  ...
  ================================================== -->
    ...
    <!-- CSS
	================================================== -->
  	<link rel="stylesheet" href="/Spring4MVChw/resources/css/zerogrid.css">
	<link rel="stylesheet" href="/Spring4MVChw/resources/css/style.css">
	<link rel="stylesheet" href="/Spring4MVChw/resources/css/lightbox.css">
	
	<!-- Custom Fonts -->
    <link href="/Spring4MVChw/resources/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
	
	
	<link rel="stylesheet" href="/Spring4MVChw/resources/css/menu.css">
	<script src="/Spring4MVChw/resources/js/jquery1111.min.js" type="text/javascript"></script>
	<script src="/Spring4MVChw/resources/js/script.js"></script>
    ...
    <![endif]-->
    <!--[if lt IE 9]>
		<script src="/Spring4MVChw/resources/js/html5.js"></script>
		<script src="/Spring4MVChw/resources/js/css3-mediaqueries.js"></script>
	<![endif]-->
...
<body class="home-page">
	<div class="wrap-body">
		<div class="header">
			<div id='cssmenu' >
				<ul>
				   <li class="active"><a href='index.jsp'><span>zAnimal</span></a></li>
			...
			<div class="custom-banner">
				<img src="/Spring4MVChw/resources/images/main.jpg">
			</div>
		</div>
		<!--////////////////////////////////////Container-->
				...
				<section class="content-box boxstyle-1 box-1">
					<div class="zerogrid">
						<div class="row wrap-box"><!--Start Box-->
							<div class="col-1-3">
								<div class="wrap-col">
									<p style="font-size: 1.9rem; font-weight: 300; letter-spacing: .19em; color: #fff; margin-bottom: .62em;">ZANIMAL</p>
									<p>
										<div class="uppercase">
											Nam liber tempor
											<br>
						...
						<div class="row wrap-box"><!--Start Box-->
							...
							<div class="row">
								<div class="col-1-3">
									<div class="wrap-col">
										<div class="portfolio-box">
											<img src="/Spring4MVChw/resources/images/1.jpg" class="img-responsive" alt="">
										...
										<div class="portfolio-box">
											<img src="/Spring4MVChw/resources/images/4.jpg" class="img-responsive" alt="">
											<div class="portfolio-box-caption">
												<div class="portfolio-box-caption-content">
													<div class="project-category text-faded">
														<a href="#">Category</a>
								...
								<div class="col-1-3">
									<div class="wrap-col">
										<div class="portfolio-box">
											<img src="/Spring4MVChw/resources/images/2.jpg" class="img-responsive" alt="">
											<div class="portfolio-box-caption">
												<div class="portfolio-box-caption-content">
													<div class="project-category text-faded">
														<a href="#">Category</a>
										...
										<div class="portfolio-box">
											<img src="/Spring4MVChw/resources/images/5.jpg" class="img-responsive" alt="">
											<div class="portfolio-box-caption">
												<div class="portfolio-box-caption-content">
													<div class="project-category text-faded">
														<a href="#">Category</a>
								...
								<div class="col-1-3">
									<div class="wrap-col">
										<div class="portfolio-box">
											<img src="/Spring4MVChw/resources/images/3.jpg" class="img-responsive" alt="">
											<div class="portfolio-box-caption">
												<div class="portfolio-box-caption-content">
													<div class="project-category text-faded">
														<a href="#">Category</a>
										...
										<div class="portfolio-box">
											<img src="/Spring4MVChw/resources/images/6.jpg" class="img-responsive" alt="">
											<div class="portfolio-box-caption">
												<div class="portfolio-box-caption-content">
													<div class="project-category text-faded">
														<a href="#">Category</a>
					...
					<div class="zerogrid">
						<div class="row wrap-box"><!--Start Box-->
							<div class="row">
								...
								<div class="col-1-2">
									<div class="wrap-col">
										<img class="" src="/Spring4MVChw/resources/images/4.jpg" alt=""/>
									</div>
								</div>
							</div>
						</div>
